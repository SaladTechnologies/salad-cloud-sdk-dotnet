...
/// <summary>
/// Service class providing access to API endpoints for OrganizationDataService.
...
public class OrganizationDataService : BaseService
{
    ...
    )
    {
        ...
        GpuClassesList result;
        if (contentLength == null || contentLength > 0)
        {
            result =
                await responseContent
                    .ReadFromJsonAsync<GpuClassesList>(_jsonSerializerOptions, cancellationToken)
                    .ConfigureAwait(false)
