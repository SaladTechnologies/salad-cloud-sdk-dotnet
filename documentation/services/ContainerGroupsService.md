...
var resources = new ContainerResourceRequirements(2, 57018, gpuClasses, 10190895817);
...
var http = new ContainerLoggingConfigurationHttp2("host", 46840, ContainerHttpLoggingConfigurationFormat2.Json, ContainerHttpLoggingConfigurationCompression2.None, "user", "password", "path", headers);
...
var networking = new CreateContainerGroupNetworking(false, 60000, ContainerNetworkingProtocol.Http, 100000, TheContainerGroupNetworkingLoadBalancer.RoundRobin, 100000, true);
...
var input = new ContainerGroupCreationRequest(false, container, "name", 284, ContainerRestartPolicy.Always, countryCodes, "9 Q592CH6F", livenessProbe, networking, queueAutoscaler, queueConnection, readinessProbe, startupProbe);
...
var headersItem = new ContainerLoggingHttpHeader("name", "value");
var headers = new List<ContainerLoggingHttpHeader>() { headersItem };
var http = new ContainerLoggingConfigurationHttp1("host", 55354, ContainerHttpLoggingConfigurationFormat1.Json, headers, ContainerHttpLoggingConfigurationCompression1.None, "user", "password", "path");
var newRelic = new NewRelicLoggingConfiguration("host", "ingestion_key");
var splunk = new ContainerLoggingSplunkConfiguration("host", "token");
var tcp = new TcpLoggingConfiguration("host", 44671);
...
var registryAuthentication = new ContainerRegistryAuthentication(awsEcr, basic, dockerHub, gcpGar, gcpGcr);
var gpuClasses = new List<string>() { "gpu_classes" };
var resources = new ContainerResourceUpdateSchema(6, 56406, gpuClasses, 7030693392);
...
var countryCodes = new List<CountryCode>() { CountryCode.Af };
var networking = new UpdateContainerGroupNetworking(45473);
var command = new List<string>() { "command" };
var exec = new ContainerGroupProbeExec(command);
var grpc = new ContainerGroupGRpcProbe(37648, "service");
var headersItem = new ContainerGroupProbeHttpHeader("name", "value");
...
var startupProbe = new ContainerGroupStartupProbe(15, 1106, 3, 2, 10, exec, grpc, http, tcp);
var queueAutoscaler = new QueueBasedAutoscalerConfiguration(53, 291, 54, 65, 100, 140);
var input = new ContainerGroupPatch("Jjdnvuz", container, 100, countryCodes, networking, livenessProbe, readinessProbe, startupProbe, queueAutoscaler);
