...
var resources = new ContainerResourceRequirements(13, 28311, gpuClasses, 20719714697);
...
var queueConnection = new ContainerGroupQueueConnection("path", 39086, "dawtm7q4ohrrc63u35mpg4-370h--6se6eqezp-gj0");
var command = new List<string>() { "command" };
var exec = new ContainerGroupProbeExec(command);
var grpc = new ContainerGroupGRpcProbe(4792, "service");
var headersItem = new ContainerGroupProbeHttpHeader("name", "value");
...
var input = new ContainerGroupCreationRequest(true, container, "name", 257, ContainerRestartPolicy.Always, countryCodes, "QTB", livenessProbe, networking, queueAutoscaler, queueConnection, readinessProbe, startupProbe);
...
var input = new ContainerGroupInstancePatch(76724);
